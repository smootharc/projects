...
firefox system-config-printer-gnome xfce4-pulseaudio-plugin pinfo clementine libdatetime-perl \
pan sabnzbdplus zathura a2ps fossil dwww ncdu rlwrap smartmontools backintime-qt4 sshfs \
tcl8.6 tcllib tkinspect tcl8.6-doc tk8.6 tk8.6-doc expect lightdm-gtk-greeter-settings exim4
