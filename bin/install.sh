...
apt-get -y install \
tmux ranger mpv feh glances moreutils configure-debian openssh-server apt-file xfce4-goodies \
firefox pinfo hddtemp googler ddgr pdd gcalcli vim-gtk herbstluftwm dmenu stalonetray restic \
