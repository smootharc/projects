...
apt update
apt install xfce4-goodies ranger mpv feh htop glances desktop-webmail firefox system-config-printer-gnome xfce4-pulseaudio-plugin pan sabnzbdplus zathura a2ps fossil dwww
